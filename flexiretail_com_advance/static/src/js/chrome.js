...
"use strict";
	...
	chrome.Chrome.include({
		events: {
            ...
            "click #sale_person_chrome" :"sale_person_chrome",
        },
		...
		sale_person_chrome: function(){
			var self = this;
			if(self.pos.get_cashier() && self.pos.get_cashier().sales_persons.length > 0){
			    self.pos.gui.show_popup('sale_person_list');
			}else{
			    self.pos.db.notification('warning',"Please configure Sales Person!");
			}
		},
