odoo.define('flexiretail_com_advance.models', function (require) {
    ...
    models.load_fields("account.journal", ['shortcut_key','jr_use_for','apply_charges','fees_amount','fees_type','optional', 'jr_for_credit_note']);
...
//                            	order.clear_cart();
        ...
        set_ret_o_inv_origin: function(number){
            this.set('ret_o_inv_origin', number);
        },
        get_ret_o_inv_origin:function(number){
            return this.get('ret_o_inv_origin');
        },
//        Payment Summary
...
//            		  var change = this.get_total_paid() - this.getNetTotalTaxIncluded() - this.get_order_total_discount();
        ...
        get_delivery_destinatario : function(){
            return this.delivery_destinatario;
        },
        set_delivery_destinatario : function(delivery_destinatario){
            this.delivery_destinatario = delivery_destinatario;
        },
...
// Credit debit finish here.
        ...
        export_as_JSON: function() {
            ...
            var new_val = {
                ...
                ret_o_inv_origin : this.get_ret_o_inv_origin(),
                ...
                delivery_destinatario: this.get_delivery_destinatario() || false,
